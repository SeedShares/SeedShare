...
{
    resize(823, 425);
    setWindowTitle(tr("Seed Shares") + "" + tr(""));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SeedShares address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About SeedShares"), this);
    aboutAction->setToolTip(tr("Show information about SeedShares"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SeedShares"));
...
void BitcoinGUI::createToolBars()
{
    ...
    mainIcon->setPixmap(QPixmap(":images/dark-vertical"));
    mainIcon->show();
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SeedShares client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SeedShares client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SeedShares network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SeedShares address or malformed URI parameters."));
    }
...
void BitcoinGUI::mainToolbarOrientation(Qt::Orientation orientation)
{
    ...
    {
        mainIcon->setPixmap(QPixmap(":images/dark-horizontal"));
        mainIcon->show();
