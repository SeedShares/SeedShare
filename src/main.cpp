...
int nCoinbaseMaturity = 90;                          // ~1.83 Hours
...
const string strMessageMagic = "SeedShares Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SeedShares", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Welcome to SeedShares!! The All new onion ecosystem seed dispensary!";
        CTransaction txNew;
        txNew.nTime = 1431766114;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1431766114;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1731691  : 1731691 ;
        ...
        assert(block.hashMerkleRoot == uint256("0x20b6557119acf71e37ceccb7183eeeee7d14d91b784e13e4497d8d619ee999d8"));
		block.print();
